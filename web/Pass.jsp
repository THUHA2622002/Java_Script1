<%-- 
    Document   : Pass
    Created on : Mar 15, 2023, 7:32:10 PM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
        <div  class="container text-center">
            ...
            <p style="text-align: center">Re-pass Must Equal Password</p>
             <a class="nav-link btn-outline" href="/Aproject_1/login">Login lai</a>
        </div>
    </body>
</html>
