...
public class DAO {
    ...
    public List<Product> getAllProduct() {
        ...
        try {
            conn = new DBContext1().getConnection();//mo ket noi voi sql
    ...
    public void singup(String user, String pass) throws Exception {
    ...
    public List<Product> getTop6(int id) {
        List<Product> list = new ArrayList<>();
    ...
    public static void main(String[] args) {
        ...
        int id = p.getId();
        List<Product> list = dao.getAllProductSellID(2);
        for (Product o : list) {
